...
```bash
./.build/app/Fire.app/Contents/MacOS/Fire --verify-hide   # 또는 open -n .build/app/Fire.app --args --verify-hide
```
...
| Phase 7 실사용 검증 | 진행 중 — 아래 "아직 검증되지 않은 것" 참고 |
